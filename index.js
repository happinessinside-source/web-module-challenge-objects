...
let newObject = createMenuItem("tacos", 8, "Lunch")
...
let fourthObject = createMenuItem("Pizza", 5, "Lunch")
let fifthObject = createMenuItem("Nachos", 5, "Lunch")
let sixthObject = createMenuItem("Burger", 18, "Lunch")
console.log(newObject, fourthObject, fifthObject, sixthObject);
...
*/
reviews.push({ name: "Jon", rating: 5, feedback: "i loved it" });
console.log(reviews);
...
function getLastReview(customer) {
    let last = customer[customer.length - 1];
